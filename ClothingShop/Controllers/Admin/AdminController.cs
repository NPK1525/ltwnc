...
namespace ClothingShop.Controllers.Admin
{
    ...
    public class AdminController(ApplicationDbContext context) : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            ViewBag.PendingOrders = await _context.Orders.CountAsync(o => o.Status == OrderStatus.Pending.ToVietnamese());
            ...
            var financialData = await _context.OrderItems
                .Where(oi => oi.Order.OrderDate >= sevenDaysAgo && oi.Order.Status == OrderStatus.Delivered.ToVietnamese())
